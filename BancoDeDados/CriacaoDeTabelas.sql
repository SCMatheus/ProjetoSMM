...
VALUES ('Salada de bacalhau', 
		...
		'https://www.youtube.com/watch?v=h8-9uKIUNFY'
		)
...
INSERT INTO Receitas (Nome, Descricao, Tipo, Ingredientes, ModoDePreparo, TempoDePreparo, NumeroDePorcoes, LinkImagem, LinkVideo)
VALUES ('Esfiha aberta', 
		'Uma deliciosa esfiha árabe aberta.',
		1,
		'1/2 kg de farinha de trigo;10 g de fermento para pão;2 colheres de açúcar;1/2 colher (chá) de sal;300 ml de água morna;65 ml de óleo;fubá para polvilhar;frango com catupiry ou de carne moída a gosto',
		'Coloque o fermento, açúcar, sal, óleo e água numa vasilha e misture com uma colher.;Adicione o trigo aos poucos e sove a massa até desgrudar da mão, ela não fica dura mas se ficar mole demais coloque um pouco de farinha de trigo.;Faça bolinhas de tamanhos iguais, polvilhe com fubá e deixe crescer em uma forma quadrada.;Coloque no máximo 4 bolinhas, quando crescer pegue o recheio e faça uma bolinha.;Coloque sobre a bolinha de massa, abra com o recheio de sua preferência e asse a 200° até dourar.',
		10,
		14,
		'https://img.itdg.com.br/tdg/images/recipes/000/181/742/334076/334076_original.jpg?mode=crop&width=710&height=400',
		'https://www.youtube.com/watch?v=mLNXD2Qjfk4'
		)
		
INSERT INTO Receitas (Nome, Descricao, Tipo, Ingredientes, ModoDePreparo, TempoDePreparo, NumeroDePorcoes, LinkImagem, LinkVideo)
VALUES ('Farofa verde (vegetariana)', 
		'Uma deliciosa farofa feita somente com ingredientes naturais.',
		4,
		'2 colheres de sopa de óleo de canola;1/2 unidade e cebola;1/2 xícara de alho poró;1 xícara de abobrinha;2 folhas de couve;1/2 xícara de azeitona;1/2 colher de chá de sal;1/2 xícara de chá de salsa e cebola;1 xícara de chá de farinha de mandioca;1/2 xícara de farinha de aveia;1 colher de sopa de amaranto',
		'Refogue a cebola e o alho poro no óleo rapidamente.;Junte abobrinha e deixe cozinhar por 3 minutos.;Junte a couve, a azeitona, o sal, a salsa e cebolinha, cozinhe rapidamente e finalize misturando a farinha de mandioca, a farinha de aveia e o amaranto.',
		15,
		14,
		'https://img.itdg.com.br/tdg/images/recipes/000/171/564/151943/151943_original.jpg?mode=crop&width=710&height=400',
		'https://www.youtube.com/watch?v=9QsLePi5QGM'
		)
